...
export default function MbaPage() {
  ...
  const whatsappLink = "https://wa.me/qr/5F4MP3SUNWLFO1";
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex justify-between items-center">
          <div className="flex items-center gap-4">
            <div className="bg-white p-1.5 rounded-lg flex items-center justify-center">
              <img 
                src="https://facuminas.com.br/wp-content/uploads/2021/05/logo-facuminas.png" 
                alt="Facuminas" 
            ...
            <div className="hidden sm:flex flex-col">
              <span className="font-bold text-xs leading-none text-amber-500 uppercase tracking-wider">MBA</span>
              <span className="font-bold text-lg leading-tight tracking-tight">Liderança</span>
            </div>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            >
              <div className="flex flex-col sm:flex-row items-center gap-4 mb-6">
                <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-amber-500/10 text-amber-500 text-xs font-bold border border-amber-500/20 uppercase tracking-widest">
                  <Award size={14} /> Certificado MEC
                </div>
                <div className="flex items-center gap-2 px-3 py-1 rounded-full bg-white/5 border border-white/10">
                  <span className="text-[10px] font-bold text-zinc-500 uppercase tracking-tighter">Parceria Oficial:</span>
                  <img 
                    src="https://facuminas.com.br/wp-content/uploads/2021/05/logo-facuminas.png" 
                    alt="Facuminas" 
              ...
              <h1 className="text-4xl sm:text-5xl lg:text-6xl font-black leading-[1.1] mb-8 text-white">
                MBA em Liderança e Gestão de Pessoas com Aulas ao Vivo, Mentoria em Grupo e <span className="text-transparent bg-clip-text bg-gradient-to-r from-amber-200 via-amber-500 to-amber-200">Diploma Reconhecido pelo MEC</span>
              </h1>
              ...
              <div className="flex flex-col sm:flex-row items-center gap-4 mb-12">
                ...
                <a 
                  href="https://wa.me/qr/5F4MP3SUNWLFO1"
                  target="_blank"
